...
description: Turn a catalog template into a running bench, and read the eleven pipeline steps while they run.
---
...
4. Watch the eleven steps. Open the **Deploy log** tab to see them.
   ...
   | 6 | Writing common_site_config.json | Points the bench at the shared database and Redis |
