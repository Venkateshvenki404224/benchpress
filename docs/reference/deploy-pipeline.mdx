...
description: The eleven steps of a BenchPress deploy, in the order the code runs them, with the function behind each step and the log line it writes.
---
...
| 6 | `site_config` | Writing common_site_config.json | `docker_manager.write_file_to_container` |
...
## Step 6. Writing common_site_config.json
