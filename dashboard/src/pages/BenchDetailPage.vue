	...
	<div class="animate-fade-up" v-if="bench">
		...
		<div class="flex items-center justify-between mb-8">
			<div class="flex items-center gap-3">
				...
				<div>
					<h1 class="text-2xl font-bold text-bp-text">
		...
		<GlassCard class="!border-bp-red/20">
			...
			<p class="text-bp-muted text-sm mb-3">
...
async function deleteBench() {
	...
	try {
		await $call("benchpress.api.bench_action", {
			bench_name: bench.value.name,
			action: "delete",
		});
